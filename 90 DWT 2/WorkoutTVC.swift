...
//                        cell.roundLabel6.text = roundNumbers[5]
                    ...
                    if workoutIndex == 1 && CDOperation.getImportPreviousSessionData() == true {
                        ...
                        localIndex = CDOperation.findMaxIndexForWorkout(workoutName: self.selectedWorkout)
                    }
                    else {
                    ...
                    if let workoutObjects = CDOperation.getRepWeightTextForExercise(localSession, workout: selectedWorkout, exercise: titleArray![0] as! String, index: localIndex as NSNumber) as? [Workout] {
